...
using System.Web;
using Operativa.ComponenteSQL.Conexion.SQL;
...
namespace Operativa.ComponenteSQL.Conexion.SQL
{
    public class SQL
    {
        ...
        Conexion_sqls conexion = new Conexion_sqls();
        ...
        //Fecha Modificación:
        //Cambios Realizados:
        public DataTable SQLSSelect(string tipoconexion, string query)
        {
            ...
            try
            {
                ...
                {
                    mySqlSelectconex = conexion.SQLSSTRINGCONNECT(tipoconexion);
                ...
                if (!mySqlSelectconex.Contains("error") && !string.IsNullOrEmpty(mySqlSelectconex))
                {
                    ...
                    if (!string.IsNullOrEmpty(query))
                    {
                        try
                        {
                            ...
                            tmpMySqlSelectCur = conexion.select_sqls(query, mySqlSelectconex);
        ...
        //Fecha Modificación:
        //Cambios Realizados:
        /*public DataTable SQLSSelect_Masivo(string tipoconexion, string query)
        {
        ...
        //Fecha Modificación:
        //Cambios Realizados:
        public bool SQLSInsert(string tipoconexion, string tablaInsert, Dictionary<string, object> Dict_Insert, string metodo, string contrato)
        {
            /*Usuario*/
            string Usuario = "";
            //if (!Util.IsNullOrEmpty(System.Web.HttpContext.Current.Session["n_usuario_activo"]))
            //{
            //    Usuario = System.Web.HttpContext.Current.Session["n_usuario_activo"].ToString();
            //}
            /*Fin Usuario*/
            ...
            try
            {
                ...
                tmpMySqlInsertC = SQLSSelect(tipoconexion, "select TOP 1 * from " + tablaInsert);
                ...
                try
                {
                    ...
                    if (!mySqlSelectconex.Contains("error") && !string.IsNullOrEmpty(mySqlSelectconex) && !string.IsNullOrEmpty(sentencia_sql))
                    {
                        ...
                        banderaTransaccion = conexion.Executes_sqls(sentencia_sql, mySqlSelectconex);
                    ...
                    if (/*!banderaTransaccion &&*/ tablaInsert.ToLower() != "bitacora_componente_sql")
                    {
                        ...
                        Util.Bitacora_ComponenteSQL(Usuario, sentencia_sql, banderaTransaccion, "SQLS-" + tipoconexion, metodo, contrato);
                    }
        ...
        //Fecha Modificación:
        //Cambios Realizados
        public bool SQLSUpdate(string tipoconexion, string tablaUpdate, Dictionary<string, object> oDict_, Trictionary<string, object, string[]> oDict2_, string metodo, string contrato)
        {
            /*Usuario*/
            string Usuario = "";
            //if (!Util.IsNullOrEmpty(System.Web.HttpContext.Current.Session["n_usuario_activo"]))
            ...
            {
                DataTable tmpMySqlInsertC = new DataTable();
                tmpMySqlInsertC = SQLSSelect(tipoconexion, "select TOP 1 * from " + tablaUpdate);
                ...
                for (int i = 0; i < long2; i++)
                {
                    ...
                    switch (Campos2[i, 2])
                    {
                        ...
                        case "INT16":/*Valida si es lógico o númerico*/
                            ...
                            Campos2[i, 0] = "ISNULL(" + oDict2_.Keys[i].ToString().Trim() + ",0)";
                ...
                try
                {
                    ...
                    int johexitcant = 0;
                    int johexitbandera = 0;
                    //Si la conexión no se establece reintentamos 2 veces esperando 1 segundos entre cada intento
                    while (johexitbandera < 1 && johexitcant < 3)
                    {
                        mySqlSelectconex = conexion.SQLSSTRINGCONNECT(tipoconexion);
                        if (!string.IsNullOrEmpty(mySqlSelectconex))
        ...
        //Fecha Modificación:
        //Cambios Realizados
        public bool SQLSDelete(string tipoconexion, string tablaDelete, Trictionary<string, object, string[]> oDict, string metodo, string contrato)
        {
            ...
            {
                DataTable tmpMySqlInsertC = new DataTable();
                tmpMySqlInsertC = SQLSSelect(tipoconexion, "select TOP 1 * from " + tablaDelete);
                ...
                for (int i = 0; i < long2; i++)
                {
                    ...
                    switch (Campos2[i, 2])
                    {
                        ...
                        case "INT16":/*Valida si es lógico o númerico*/
                            ...
                            Campos2[i, 0] = "ISNULL(" + oDict.Keys[i].ToString().Trim() + ",0)";
        ...
        public bool SQLSDirecto(string tipoconexion, string tabla, string query, string metodo, string contrato)
        {
            /*Usuario*/
            string Usuario = "";
            //if (!Util.IsNullOrEmpty(System.Web.HttpContext.Current.Session["n_usuario_activo"]))
            ...
            try
            {
                ...
                {
                    //AQUI HACEMOS LA INSERCCION DE MYSQL
                    banderaTransaccion = conexion.Executes_sqls(query, mySqlSelectconex);
                ...
                if (/*!banderaTransaccion &&*/ !query.ToLower().Contains("bitacora_componente_sql"))
                {
                    //Si se cae el query insertamos en bitacora
                    //Mientras sea diferente de la bitacora, para no enciclar
                    Util.Bitacora_ComponenteSQL(Usuario, query, banderaTransaccion, "SQLS-" + tipoconexion, metodo, contrato);
                }
            }
            catch (Exception exc)
            {
        ...
        //Fecha Modificación:
        //Cambios Realizados:
        public bool SQLSMASIVO(string tipoconexion, string tablaInsert, DataTable Dict_Insert_Masivo, string metodo)
        {
            //newCulture = new CultureInfo("en-US");
            //CultureInfo.DefaultThreadCurrentCulture = newCulture;
            //CultureInfo myCIclone = (CultureInfo)newCulture.Clone();
